...
const DEFAULT_KEYWORDS = {
  ...
  Circuit: ['circuit', 'kmap', 'logic', 'pcb', 'schematic', 'spice', 'ltspice', 'multisim', 'proteus', 'waveform', 'fpga', 'verilog', 'vhdl', 'quartus', 'vivado', 'simulink', 'matlab', 'oscilloscope', 'bode', 'fft', 'datasheet', '電路', '波形', '示波器', '規格書', '模擬'],
