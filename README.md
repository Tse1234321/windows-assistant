...
[![Version](https://img.shields.io/badge/version-2.5.5-2f7bf6.svg)](#)
...
1. Download the latest Windows installer: [PC-Life-Assistant-Setup-2.5.5.exe](https://github.com/Tse1234321/windows-assistant/releases/download/v2.5.5/PC-Life-Assistant-Setup-2.5.5.exe).
...
```text
release-auto\PC-Life-Assistant-Setup-2.5.5.exe
```
